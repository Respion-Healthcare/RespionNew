...
export default function PrivacyPage() {
  return (
    <>
      <Head>
        <title>Privacy Policy | Respion India</title>
        <meta
          name="description"
          content="Read Respion's Privacy Policy to understand how we collect, use, protect, and process your personal information in compliance with Indian data protection laws."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Privacy Policy | Respion" />
        <meta
          property="og:description"
          content="Learn how Respion collects, uses, and safeguards your personal information."
        />
        <meta property="og:url" content="https://respion.in/privacy-policy" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebPage",
              name: "Privacy Policy",
              url: "https://respion.in/privacy-policy",
              description:
                "Respion Privacy Policy explaining data collection, use, security practices, and user rights under Indian law.",
              publisher: {
                "@type": "Organization",
                name: "Respion",
        ...
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          <div className="space-y-10 text-gray-700 leading-relaxed text-[16px]">
            ...
            <section>
              ...
              <p>
                This Privacy Policy describes how <strong>Respion</strong> collects,
            ...
            <section>
              ...
              <p className="mt-4">
                ...
                third-party payment gateways. Respion does not store card
            ...
            <section className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-lg shadow-sm">
              ...
              <p>
                Respion will never ask for your OTP, card PIN, net banking
                password, or sensitive credentials. If anyone requests such
                information claiming to represent Respion, please report it
                immediately.
              </p>
            </section>
