...
export const metadata: Metadata = {
  title: "Return & Refund Policy | Respion",
  description:
    "Read Respion's return, replacement, and refund policy for CPAP machines, BiPAP machines, oxygen concentrators, masks, and accessories.",
}
