...
if (slug === "mask") {
  return {
    title: "CPAP Masks & BiPAP Masks Online in India | Respion",
    description:
...
if (slug === "accessory") {
  return {
    title: "CPAP & BiPAP Accessories Online in India | Respion",
    description:
  ...
  return {
    title: `${formattedName} Price in India | Buy Online - Respion`,
    description: `Buy ${formattedName} online in India at best price from Respion. Explore premium quality products with fast delivery and trusted support.`,
    keywords: [
      formattedName,
    ...
    <p className="text-gray-600 text-sm">
      Support
        ...
        <p className="text-gray-600 mb-10 max-w-3xl">
          Explore premium quality {categoryTitle} products at Respion.
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              name: categoryTitle,
              url: `https://www.respion.in/category/${slug}`,
              description: `Buy ${categoryTitle} online in India at best price from Respion.`,
              publisher: {
                "@type": "Organization",
                name: "Respion",
                url: "https://www.respion.in",
              },
            }),
          }}
        />
