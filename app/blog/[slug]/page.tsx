...
export async function generateMetadata({
  ...
  if (!blog) {
    return {
      title: "Respion Blog",
      description: "Respion Blog",
    }
  }

  return {
    title: `${blog.title} | Respion`,
    description: blog.excerpt,

    alternates: {
      canonical: `https://respion.in/blog/${safeSlug}`,
    },

    openGraph: {
      title: blog.title,
      description: blog.excerpt,
      url: `https://respion.in/blog/${safeSlug}`,
      type: "article",
      images: [
        {
          url: `https://respion.in${blog.image}`,
          width: 1200,
          height: 630,
          alt: blog.title,
        },
    ...
    twitter: {
      ...
      title: blog.title,
      description: blog.excerpt,
      images: [`https://respion.in${blog.image}`],
    },
...
const blogSchema = {
  ...
  image: [`https://respion.in${blog.image}`],

  mainEntityOfPage: {
    "@type": "WebPage",
    "@id": `https://respion.in/blog/${safeSlug}`,
  },
