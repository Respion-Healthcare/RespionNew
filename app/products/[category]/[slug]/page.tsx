...
export async function generateMetadata({ params }: any): Promise<Metadata> {
  ...
  return {
    title: `${product.name} | Respion`,
    description: `Explore ${product.name} with warranty, sleep apnea support, and fast delivery from Respion.`,
    alternates: {
      canonical: `https://www.respion.in/products/${product.category}/${product.slug}`,
    },
    openGraph: {
      title: product.name,
    ...
    <div className="w-full px-4 sm:px-6 lg:max-w-7xl lg:mx-auto pt-8 pb-16">
      ...
      <div className="prose prose-lg max-w-none mt-20">
        ...
        <ul>
          ...
          <li>Backed by Respion expert team support</li>
        </ul>
      </div>
