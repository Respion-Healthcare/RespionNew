...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <title>
          About Respion | CPAP, BiPAP & Sleep Therapy Experts in India
        </title>

        <meta
          name="description"
          content="Respion is a trusted provider of CPAP, BiPAP, oxygen concentrators, sleep study services, and respiratory healthcare solutions across India."
        />

        <meta
          name="keywords"
          content="Respion, CPAP India, BiPAP India, sleep therapy India, oxygen concentrator India, respiratory care India"
        />
        ...
        <link rel="canonical" href="https://respion.in/about" />

        {/* OPEN GRAPH */}
        <meta
          property="og:title"
          content="About Respion | Sleep Therapy Experts"
        />
        ...
        <meta
          property="og:image"
          content="https://respion.in/images/aboutus.webp"
        />

        <meta property="og:url" content="https://respion.in/about" />
          ...
          <section className="relative w-full min-h-[80vh] sm:min-h-screen px-4 sm:px-6 md:px-10 lg:px-20 xl:px-24 pt-4 sm:pt-6 pb-8 sm:pb-12 flex items-center">        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center w-full mt-4">
            ...
            <div>
              ...
              <p className="text-[14px] sm:text-base md:text-lg text-gray-600 leading-relaxed mb-8 max-w-2xl">
                Respion delivers premium CPAP, BiPAP, oxygen concentrators,
...
<div className="mt-6 rounded-2xl bg-white/70 backdrop-blur-xl border border-white/50 shadow-xl p-4 sm:p-5 sm:p-6">
  ...
  From major cities to smaller towns, Respion delivers across India with
            ...
            <div className="relative group float-animation">
              ...
              <div className="relative h-[320px] sm:h-[420px] md:h-[520px] lg:h-[560px] rounded-[28px] sm:rounded-3xl lg:rounded-3xl lg:rounded-[35px] p-4 sm:p-6 lg:p-8 p-4 sm:p-6 lg:p-8 overflow-hidden">
                <Image
                  ...
                  alt="Respion Sleep Therapy Team"
                  fill
                  priority
  ...
  Founded in 2025, Respion was created to improve respiratory
