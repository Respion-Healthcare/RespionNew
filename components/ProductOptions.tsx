...
export default function ProductOptions({ product }: any) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Hello Respion, I would like to inquire about "${product.name}" (${product.category}).`
  )
    ...
    <div className="mt-6">
      ...
      <div className="mt-7 p-6 rounded-3xl bg-gradient-to-br from-[#EAF8FC] via-white to-blue-50/50 border border-[#BFEAF3] shadow-sm space-y-4">
        ...
        >
          ...
          <span>Call to Inquire: 9937144165</span>
        </a>

        {/* WHATSAPP BUTTON */}
        <a
          href={`https://wa.me/919937144165?text=${whatsappMessage}`}
          target="_blank"
